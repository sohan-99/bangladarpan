        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-indigo-600">বাংলাদর্পণ</h1>
            </div>
            <Link
              href="/admin/login"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          <h2 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            Welcome to <span className="text-indigo-600">বাংলাদর্পণ</span>
          </h2>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Your trusted source for authentic news and updates
          </p>
              ...
              <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Get the latest news updates as they happen with our real-time news delivery system.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    All news articles are verified and fact-checked before publication.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                <div className="-mt-6">
                  ...
                  <p className="mt-5 text-base text-gray-500">
                    Coverage of both local Bangladeshi news and important global events.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-white mt-24">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <p className="text-center text-base text-gray-400">
            &copy; {new Date().getFullYear()} বাংলাদর্পণ. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
